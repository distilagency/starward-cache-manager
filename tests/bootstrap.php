<?php
/**
 * StarwardCacheManager Test Bootstrapper.
 *
 * @since   0.0.0
 ...
 * @since 0.0.0
 */
function _manually_load_starward_cache_manager_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/starward-cache-manager.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_starward_cache_manager_plugin' );
